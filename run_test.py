        ...
        if test_files:
            ...
            try:
                ...
                if text and len(text.strip()) > 10:
                    ...
                    print("   OCR извлек мало текста или пустой текст")
            except Exception as e:
                print(f"  Ошибка OCR: {e}")
        else:
            print("   Нет тестовых файлов в папке tests/")
...
def test_cli():
    ...
    try:
        ...
        print("ℹ   Для полного теста CLI запустите команды в терминале")
...
def test_batch_processor():
    ...
    try:
        ...
        print("ℹ   BatchProcessor готов к использованию")
